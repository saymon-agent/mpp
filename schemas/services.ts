...
export const services: ServiceDef[] = [
  ...
  // ── Saymon RU Data ──────────────────────────────────────────────────────
  {
    ...
    endpoints: [
      ...
      {
        route: "POST /v1/fns-npd-check",
        desc: "Russian self-employed (NPD) status check by INN via FNS",
        amount: "10000",
        unitType: "request",
      },
      {
        route: "POST /v1/cbr-rates",
        desc: "Central Bank of Russia official FX rates (USD, EUR, CNY and more)",
        amount: "8000",
        unitType: "request",
      },
      {
        route: "POST /v1/moex-quote",
        desc: "MOEX market quotes: stocks, FX pairs and indices",
        amount: "8000",
        unitType: "request",
      },
      {
        route: "POST /v1/chat/gpt-5.6-sol",
        desc: "LLM chat: OpenAI gpt-5.6-sol reasoning model, per call",
        amount: "20000",
        unitType: "request",
      },
      {
